...
export default function LandingPage() {
	return (
		<div className=' dark:bg-slate-950 h-screen bg-slate-400v'>
			<div className='relative isolate px-6 pt-14 lg:px-8'>
				...
				<div className='mx-auto max-w-2xl py-12'>
					<div className='text-center'>
						...
						/>
						{/* <h1 className='dark:text-gray-50 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'>Title 1</h1>
						<p className='dark:text-gray-100 mt-6 text-lg leading-8 text-gray-600'>Desc 1</p> */}
